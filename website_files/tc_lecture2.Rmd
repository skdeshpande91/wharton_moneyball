...
```{r shooting_hist_binwidth}
raw_shooting %>%
  ggplot(aes(x = FGP)) +
  geom_histogram(binwidth = 0.05)
```

<!--**Exercise** Make histograms of FTP and TPP, and other variables created in code above. Comment on the differences-->
