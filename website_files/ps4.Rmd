...
2. Run the code above and save the tbl `batting_2014_2015.RData` to the file "data/batting_2014_2015.RData". We will return to this dataset in [Module 6](module6.html).
